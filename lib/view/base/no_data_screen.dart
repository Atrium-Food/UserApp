  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.stretch, children: [
        ...
        Text(
          isWishList? 'No Favorites': getTranslated(isOrder ? 'no_order_history_available' : isCart ? 'empty_cart' : 'nothing_found', context),
        ...
        Text(
          isWishList? 'Start wishlisting your favorite dishes now' :isOrder ? getTranslated('buy_something_to_see', context) : isCart ? getTranslated('look_like_have_not_added', context) : '',
          style: rubikMedium.copyWith(fontSize: MediaQuery.of(context).size.height*0.0185), textAlign: TextAlign.center,
        ),
