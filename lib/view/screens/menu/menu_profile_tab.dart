    ...
    return Container(
      child: ListView(
        ...
        SwitchListTile(
          ...
          title: Text(getTranslated('dark_theme', context), style: robotoMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
          activeColor: Theme.of(context).primaryColor,
        ),
        ListTile(
          onTap: () => onTap(2),
          leading: Image.asset(Images.order, width: 20, height: 20, color: Theme.of(context).textTheme.bodyText1.color),
          title: Text(getTranslated('my_order', context), style: robotoMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
        ),
        ListTile(
          onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => ProfileScreen())),
          leading: Image.asset(Images.profile, width: 20, height: 20, color: Theme.of(context).textTheme.bodyText1.color),
          title: Text(getTranslated('profile', context), style: robotoMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
        ),
        ListTile(
        ...
        ListTile(
          ...
          title: Text(getTranslated('coupon', context), style: robotoMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
        ),
        // ListTile(
        ...
        //   title: Text(getTranslated('language', context), style: robotoMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
        // ),
        ListTile(
          ...
          title: Text(getTranslated('help_and_support', context), style: robotoMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
        ),
        ListTile(
          ...
          title: Text(getTranslated('terms_and_condition', context), style: robotoMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
        ),
        ListTile(
          onTap: () {
          ...
          title: Text(getTranslated('logout', context), style: robotoMedium.copyWith(fontSize: Dimensions.FONT_SIZE_LARGE)),
        ),
      ])
    );
  }
