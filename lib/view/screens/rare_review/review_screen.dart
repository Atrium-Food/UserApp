                      ...
                      Row(
                        children: [
                          ...
                          Expanded(child: Column(
                            ...
                            children: [
                              Text(widget.product.name, style: rubikMedium, maxLines: 2, overflow: TextOverflow.ellipsis),
                              SizedBox(height: 10),
                              Text(PriceConverter.convertPrice(context, widget.product.price), style: rubikBold),
                            ],
                          )),
                        ],
                      ),
