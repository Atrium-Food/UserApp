...
class OrderTrackingScreen extends StatelessWidget {
  ...
  OrderTrackingScreen({@required this.orderID, @required this.addressID,this.fromNotifs});
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: CustomAppBar(title: getTranslated('order_tracking', context),isBackButtonExist: true,
        onBackPressed: (){
          print("Back!");
          if(fromNotifs!=null && fromNotifs){
            Navigator.push(context, MaterialPageRoute(builder: (context) => DashboardScreen()));
          ...
          builder: (context, order, child) {
            ...
            return _status != null ? RefreshIndicator(
              onRefresh: () async {
                ...
                print("Delivery Man: "+order.deliveryManModel.orderId.toString());
              },
