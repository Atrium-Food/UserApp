...
class OrderTrackingScreen extends StatelessWidget {
  ...
  OrderTrackingScreen(
      {@required this.orderID, @required this.addressID, this.fromNotifs});
                ...
                ? RefreshIndicator(
                    onRefresh: () async {
                      ...
                      await Provider.of<OrderProvider>(context, listen: false)
                          .trackOrder(orderID, null, context, true);
                      print("Delivery Man: " +
                          order.deliveryManModel.latitude.toString());
                    },
                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        SizedBox(height: 50),
                        CustomButton(
                            btnTxt: getTranslated('rate_review', context),
                            onTap: () async {
                              List orderDetailsList = await Provider.of<
